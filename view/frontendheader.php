...
<head>
    ...
    <!-- CUSTOM CSS -->
    <link rel="stylesheet" type="text/css" href="<?php $GLOBALS['view_path'] ?>template/frontend/css/font.css">
    <link rel="stylesheet" type="text/css" href="<?php $GLOBALS['view_path'] ?>template/frontend/css/style.css">
    <link rel="stylesheet" type="text/css" href="<?php $GLOBALS['view_path'] ?>template/frontend/css/media_query.css">
    
    <!-- BOOTSTRAP CSS -->
    <link rel="stylesheet" type="text/css" href="<?php $GLOBALS['view_path'] ?>template/frontend/css/bootstrap.min.css">

    <!-- OWL CAROUSEL -->
    <link rel="stylesheet" type="text/css" href="<?php $GLOBALS['view_path'] ?>template/frontend/css/owl.carousel.css">
    <link rel="stylesheet" type="text/css" href="<?php $GLOBALS['view_path'] ?>template/frontend/css/owl.theme.default.css">
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-1">
				...
				<img src="<?php $GLOBALS['view_path'] ?>template/logo/logo_big.jpg" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none">

				<img src="<?php $GLOBALS['view_path'] ?>template/logo/logo_med.jpg" class="img-fluid d-xl-none d-lg-none d-md-inline d-sm-none d-none" style="width: 100px">

				<img src="<?php $GLOBALS['view_path'] ?>template/logo/logo.jpg" class="img-fluid d-xl-none d-lg-none d-md-none d-sm-inline d-inline pl-2" style="width: 30px">
			</div>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<img src="<?php $GLOBALS['view_path']?>template/frontend/image/download.png" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none" style="width: 150px">
			</div>
		</div>
	</div>
	<div id="myPage"></div>
	...
	<div id="mySidebar" class="sidebar">
		<div class="row">
			<div class="col-10">
	  			<img src="<?php $GLOBALS['view_path']?>template/logo/logo_med_trans.png" class="img-fluid" style="width: 100px">
			</div>
			<div class="col-2">
		...
		<div class="mt-3">
			...
			<img src="<?php $GLOBALS['view_path']?>template/frontend/image/download.png" class="img-fluid ml-2 text-center" style="width: 150px">
			<hr>

			<p class="text-white ml-3"> Copyright &copy; <img src="<?php $GLOBALS['view_path']?>template/logo/logo_wh_transparent.png" style="width: 20px; height: 20px"> 2019  </p>
