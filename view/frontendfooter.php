  	...
  	<footer class="py-3 mt-5">
    	<div class="container">
    		<div class="text-center pb-3">
      		...
      		<p class="m-0 text-center text-white">Copyright &copy; <img src="<?php $GLOBALS['view_path'] ?>template/logo/logo_wh_transparent.png" style="width: 30px; height: 30px"> 2019</p>
    	</div>
  	</footer>

  	<script type="text/javascript" src="<?php $GLOBALS['view_path'] ?>template/frontend/js/jquery.min.js"></script>
	<!-- BOOTSTRAP JS -->
    <script type="text/javascript" src="<?php $GLOBALS['view_path'] ?>template/frontend/js/bootstrap.bundle.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick.js"></script>
    <script type="text/javascript" src="<?php $GLOBALS['view_path'] ?>template/frontend/js/custom.js"></script>

    <!-- Owl Carousel -->
    <script type="text/javascript" src="<?php $GLOBALS['view_path'] ?>template/frontend/js/owl.carousel.js"></script>
