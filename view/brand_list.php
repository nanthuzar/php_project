                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td> <?php echo $i++; ?> </td>
                                            <td> <img src=" <?php echo $logo ?>" class="img-fluid">
                                            <?php echo $name; ?> </td>
                                            <td>
                                                ...
                                                <form class="d-inline-block" action="<?php echo $GLOBALS['view_path'] ?>brand_delete" method="POST" onsubmit="return confirm('Are you sure want to delete?')">
