...
<div class="app-title">
                ...
                <ul class="app-breadcrumb breadcrumb side">
                    <a href="<?php echo $GLOBALS['view_path']  ?>item_list" class="btn btn-outline-primary">
                  ...
                  <input type="hidden" name="oldphoto" value="<?php echo $itemedit['photo'] ?>">
                        ...
                        <div class="col-sm-10">
                           <nav>
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                      <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"><img src=" <?php echo $GLOBALS['view_path'].$itemedit['photo'] ?>">
                                      </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                         ...
                         <input type="text" class="form-control" id="name_id" name="price" value="<?php echo $itemedit['price'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="name_id" name="description" value="<?php echo $itemedit['description'] ?>">
                        </div>
                    </div>
